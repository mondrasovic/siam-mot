...
class SRPooler(nn.Module):
    ...
    Also, the requirement of passing the scales is not strictly necessary,
    as they
    ...
    def __init__(self, output_size, scales, sampling_ratio):
        """
        Arguments:
            output_size (list[tuple[int]] or list[int]): output size for the
            pooled region
        ...
        # get the levels in the feature map by leveraging the fact that the
        # network always
    ...
    def forward(self, x, boxes, sr=None):
        ...
        Arguments:
            ...
            boxes (list[BoxList]): boxes to be used to perform the pooling
            operation.
