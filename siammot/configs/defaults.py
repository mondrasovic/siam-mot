...
# attention
cfg.MODEL.TRACK_HEAD.USE_ATTENTION = True
cfg.MODEL.TRACK_HEAD.ATT_QUERY_KEY_DIM = 256
cfg.MODEL.TRACK_HEAD.ATT_VALUE_DIM = 256
cfg.MODEL.TRACK_HEAD.ATT_SOFTMAX_TEMP = 0.01
