...
parser.add_argument('--demo-video', metavar='FILE', type=str, required=True)
parser.add_argument(
    '--track-class',
    type=str,
...
parser.add_argument(
    '--dump-video', type=bool, default=False, help="dump the videos as results"
)
parser.add_argument('--vis-resolution', type=int, default=1080)
parser.add_argument(
    '--output-path', type=str, default=None, help="the path of dumped videos"
)
